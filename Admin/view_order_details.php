                        ...
                        <table class="table" style="background: #fff">
                            <tr>
                                <td style="font-size: 16px;">
                                    <?php
                                    if (array_key_exists('status', $num)) {
                                        if ($num['status'] == 1) {
                                        ...
                                        echo "<b>Trạng thái không xác định</b>";
                                    }
                            ...
                            <tr>
                                <td colspan="4" class="text-right">
                                    <form method="post">
                                        <?php
                                        if ($num['status'] == 1) {  // If the order is pending, allow confirmation
                                            ?>
                                            <input type="hidden" name="id" value="<?php echo $num['id_ddh']; ?>" >
                                            <input type="hidden" name="status" value="2"> <!-- Change status to 'confirmed' -->
